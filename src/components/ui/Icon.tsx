const ICONS: Record<string, string> = {
  ...
  hand: '<path d="M8 13V6a1.5 1.5 0 0 1 3 0v5"/><path d="M11 11V4.5a1.5 1.5 0 0 1 3 0V11"/><path d="M14 11V6.5a1.5 1.5 0 0 1 3 0V13a6 6 0 0 1-6 6h-1a5 5 0 0 1-5-5v-2.5a1.5 1.5 0 0 1 3 0V13"/>',
  ...
  micoff:
    '<line x1="4" y1="4" x2="20" y2="20"/><path d="M9 9v5a3 3 0 0 0 5.2 2"/><path d="M15 9V8a3 3 0 0 0-5.8-1"/><path d="M5 11a7 7 0 0 0 11 5"/><line x1="12" y1="18" x2="12" y2="22"/>',
  video: '<rect x="3" y="7" width="13" height="10" rx="2"/><polygon points="16 10 21 7 21 17 16 14"/>',
  videooff:
    '<line x1="3" y1="3" x2="21" y2="21"/><path d="M9 7h5a2 2 0 0 1 2 2v5"/><polygon points="16 10 21 7 21 17 16 14"/>',
  screen:
  ...
  pointer: '<path d="M5 21 L15.5 7.5"/><path d="M14.2 5.4 l3.6-3.2 2 2.2-3.6 3.2z"/><circle cx="18.6" cy="3.4" r="1.1"/>',
